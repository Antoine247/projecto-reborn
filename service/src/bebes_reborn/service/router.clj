...
(ns bebes-reborn.service.router
  ...
  (:require
   ...
   ;; Service middleware
   [bebes-reborn.service.middleware :as middleware-service]

   ;; Service Routing
   [bebes-reborn.service.api.system-admin :as system-admin]
   [bebes-reborn.service.api.scoreboard   :as scoreboard]
...
(def open-api-docs
  ...
  ["/swagger.json"
   {:get {:no-doc  true
          :swagger {:info {:title "bebes-reborn service Service API"
                           :description "TODO: Provide a meaningful description of the project"
                           :version "0.1.0"
                           :termsOfService "https://net.clojars.bebes-reborn/"
                           :contact {:name "Engineering Team"
                                     :url "https://net.clojars.bebes-reborn/wiki/engineering-team"}
                           :license {:name "© Antoine, 2025"
  ...
  (ring/ring-handler
   (ring/router
    [;; --------------------------------------------------
     ...
     ;; --------------------------------------------------
     ;; bebes-reborn service  API routes
     ["/api"
      ["/v1"
